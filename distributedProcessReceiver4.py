...
QueueManager.register('get_task_queue4')
QueueManager.register('get_result_queue4')
...
task4 = m.get_task_queue4()
result4 = m.get_result_queue4()
...
while True:
	try:
		task = Task()
		task = task4.get()
		Process(target = long_time_task, args = (task,result4)).start()
	except Queue.Empty:
