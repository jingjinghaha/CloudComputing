...
QueueManager.register('get_task_queue3')
QueueManager.register('get_result_queue3')
...
task3 = m.get_task_queue3()
result3 = m.get_result_queue3()
...
while True:
	try:
		task = Task()
		task = task3.get()
		Process(target = long_time_task, args = (task,result3)).start()
	except Queue.Empty:
