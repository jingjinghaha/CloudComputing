...
QueueManager.register('get_task_queue1')
QueueManager.register('get_result_queue1')
...
task1 = m.get_task_queue1()
result1 = m.get_result_queue1()
...
while True:
	try:
		task = Task()
		task = task1.get()
		Process(target = long_time_task, args = (task,result1)).start()
	except Queue.Empty:
